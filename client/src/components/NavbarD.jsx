...
const NavbarD = ({boardName}) => {
	return (
		<div className="md:w-[calc(100%-230px)] w-[calc(100%-60px)] fixed flex items-center border-b z-30 justify-between pl-2 pr-6 h-[70px] top-0 md:left-[230px] left-[60px]  border-slate-300 bg-[#fff]">
